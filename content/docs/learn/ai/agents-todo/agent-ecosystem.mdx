---
title: Agent
description: "LLM 智能体（Agent）技术框架与课程聚合页，涵盖 OpenHands 开源自动化平台、Kimi-Researcher 强化学习科研 Agent、OpenAI Deep Research 多步互联网研究模式及 KAG 知识图谱增强检索框架。适合 AI 开发者、科研人员及求职者系统学习 Agent 工具链与前沿实践。"
status: todo
