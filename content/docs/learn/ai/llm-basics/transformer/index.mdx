---
title: Transformer
description: "Transformer 核心论文与代码详解，涵盖 Self-Attention 的 QKV 计算、Scaled Dot-Product 与 Multi-Head Attention 原理，以及分词、位置编码、掩码、层归一化等关键技术点。适合 CS/AI 求职者、深度学习初学者及希望系统掌握 Transformer 架构的开发者阅读。"
date: "2024-01-16"
tags:
  - transformer
  - attention
