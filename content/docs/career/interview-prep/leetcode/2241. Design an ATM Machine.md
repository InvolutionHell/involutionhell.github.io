...
description: "LeetCode 2241. Design an ATM Machine 题解 — 模拟银行 ATM 的存款与取款逻辑，重点实现贪心取款策略：优先使用大面额钞票（500、200、100、50、20），并处理余额不足或无法凑整时的拒绝场景。适合准备系统设计面试或练习面向对象模拟题的算法学习者。"
date: "2025-01-06"
tags:
  - - Python
  - - Answer
