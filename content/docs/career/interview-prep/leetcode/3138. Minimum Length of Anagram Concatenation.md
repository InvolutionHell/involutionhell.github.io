...
description: "LeetCode 3138. Minimum Length of Anagram Concatenation 题解 — 利用字符频率计数与最大公约数（GCD）判断字符串是否由若干变位词拼接而成，核心技巧是枚举可能的分段长度并验证各段字符计数一致。适合正在刷字符串与数学类题目的算法求职者。"
date: 20/12/2024
tags:
  - Python
  - Prefix Sum
