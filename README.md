...
本项目采用**双协议**：**代码**与**内容**分别授权。

| 部分                                                                | 协议                               | 文件                                 |
| ------------------------------------------------------------------- | ---------------------------------- | ------------------------------------ |
| **代码**（构建/运行网站的程序：`app/`、`lib/`、组件、脚本、配置等） | [Apache License 2.0](LICENSE)      | [`LICENSE`](LICENSE)                 |
| **内容**（`content/docs/` 下的文章、文档等创作内容）                | [CC BY-NC-SA 4.0](LICENSE-CONTENT) | [`LICENSE-CONTENT`](LICENSE-CONTENT) |

### 关于项目代码（Apache-2.0）

构建和运行本网站的**程序代码**依据 [Apache License 2.0](LICENSE) 开源。你可以自由使用、修改、再分发（含商用），保留版权与 NOTICE 即可。

### 关于文档内容（CC BY-NC-SA 4.0）

`content/docs/` 下的**文章与文档**依据 [署名-非商业性使用-相同方式共享 4.0（CC BY-NC-SA 4.0）](LICENSE-CONTENT)授权：可在**非商业**前提下复制、修改、分发，但需保留署名，并以相同协议共享衍生作品。**商业用途需另行获得授权。**
